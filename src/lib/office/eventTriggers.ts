...
export type BooleanByAgentId = Record<string, boolean>;
...
export type PhoneCallByAgentId = Record<string, OfficePhoneCallRequest>;
...
export type TextMessageByAgentId = Record<string, OfficeTextMessageRequest>;
