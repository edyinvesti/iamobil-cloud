...
- Lembre-se: O Gênio Fix NÃO deve tentar corrigir suas próprias correções se elas falharem mais de uma vez.

### 2. Segurança de Escrita e File System
- Backup Obrigatório: SEMPRE crie um arquivo .bak antes de usar ferramentas de escrita.

### 3. Transparência e Logs
- Relatório de Impacto: Todo reparo deve ser registrado em REPAROS_IA.md.
`;
