...
export type PackagedSkillId = "task-manager" | "todo-board" | "security-protocol" | "ceo-notification";
...
const PACKAGED_SKILLS: PackagedSkillDefinition[] = [
  ...
  {
    packageId: "security-protocol",
    skillKey: "security-protocol",
    name: "security-protocol",
    description: "Protocolo de segurança e boas práticas para manutenção de software autônoma.",
    installSource: "openclaw-workspace",
    creatorName: "Antigravity",
    creatorUrl: "https://google.com/",
  },
  {
    packageId: "ceo-notification",
    skillKey: "ceo-notification",
    name: "ceo-notification",
    description: "Permite que agentes enviem alertas críticos diretamente para o CEO via Telegram.",
    installSource: "openclaw-workspace",
    creatorName: "Antigravity",
    creatorUrl: "https://google.com/",
  },
