...
export async function runStudioBootstrapLoadOperation(params: {
  ...
  try {
    ...
    console.log(`[studio-bootstrap] hydrateAgentFleetFromGateway returned ${result.seeds.length} seeds`);
    ...
    console.log(`[studio-bootstrap] Generated ${commands.length} commands. hydrate-agents seeds count: ${result.seeds.length}`);
