...
const FILTER_OPTIONS: Array<{ value: FocusFilter; label: string; testId: string }> = [
  { value: "all", label: "Tudo", testId: "fleet-filter-all" },
  { value: "running", label: "Executando", testId: "fleet-filter-running" },
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 px-1">
        <p className="console-title type-page-title text-foreground">Agentes ({agents.length})</p>
        <button
          type="button"
        ...
        >
          {createBusy ? "Criando..." : "Novo agente"}
        </button>
      </div>
