  ...
  return (
    <div className="ui-topbar relative z-[180]">
      <div className="grid h-10 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center px-3 sm:px-4 md:px-5">
        ...
        <p className="truncate text-sm font-semibold tracking-[0.01em] text-foreground">IAmobil Imobiliária</p>
        <div className="flex items-center justify-end gap-1">
          {status !== "disconnected" ? (
            ...
            >
              {status === "connecting" ? "Conectando" : "Conectado"}
            </span>
          ) : null}
          <ThemeToggle />
          {showConnectionSettings ? (
            <div className="relative z-[210]" ref={menuRef}>
              ...
              >
                ...
                <span className="sr-only">Abrir menu do estúdio</span>
              </button>
              {menuOpen ? (
