  ...
  return (
    ...
    >
      ...
      <div className="mt-2 grid gap-1 text-[11px] text-muted-foreground sm:grid-cols-2">
        <div>Máquina: {approval.host ?? "desconhecida"}</div>
      ...
      <div className="mt-2 flex flex-wrap gap-2">
        <button
          ...
          disabled={disabled}
          aria-label={`Permitir uma vez para a aprovação ${approval.id}`}
        >
          Permitir uma vez
        </button>
        <button
          ...
          disabled={disabled}
          aria-label={`Permitir sempre para a aprovação ${approval.id}`}
        >
          Sempre permitir
        </button>
        <button
...
export const AgentChatPanel = ({
  ...
  return (
    <div data-agent-panel className="group fade-up glass-panel relative flex h-full w-full flex-col">
