...
export function SkillsMarketplaceModal({
  ...
  return (
    ...
    >
      <div
        className="flex h-[min(90vh,960px)] w-full max-w-6xl flex-col overflow-hidden rounded-xl border border-cyan-500/20 shadow-2xl glass-panel"
        ...
        <div className="flex items-start justify-between gap-4 border-b border-cyan-500/10 px-5 py-4">
          <div>
            ...
            <div className="mt-1 font-mono text-[11px] text-white/45">
              Descubra, instale e ative habilidades de gateway em um espaço de trabalho amplo.
            </div>
          </div>
          <button
            type="button"
