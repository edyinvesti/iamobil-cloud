...
- o quadro não deve depender de métodos específicos de provedores legados.
- users can turn whiteboard outputs into bulletin board items or task seeds
- o sistema funciona independentemente de comportamentos específicos de provedores legados
